...
describe('DELETE /todos/:id', () => {
  it('should remove a todo', (done) => {
    var nid = todos[1]._id.toHexString();
    ...
    request(app)
      ...
      .expect(200)
      .expect((res) => {
        expect(res.body.todo._id).toBe(nid);
      })
      .end((err, res) => {
        if(err){
          return done(err);
        }
        Todo.findById(nid).then((todo) => {
  ...
  it('should not remove a todo created by another user', (done) => {
    var nid = todos[0]._id.toHexString();
...
describe('PATCH /todos/:id', () => {
  it('should update the todo', (done) => {
    let nid = todos[0]._id.toHexString();
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    let nid = todos[1]._id.toHexString();
